-- $Id: DatabaseSchema.sql 119 2009-05-14 09:22:47Z dna $
...
CREATE TABLE "Users" (
	...
	"PasswordQuestion"							character varying(255)	NOT NULL DEFAULT '',
	"PasswordAnswer"							character varying(255)	NOT NULL DEFAULT '',
...
-- PostgreSQL 8 OpenID Extension Schema

CREATE TABLE "OpenIDAccounts" (
  "pId"      serial NOT NULL,
  "UserName"   character varying(255) NOT NULL,
  "ApplicationName" character varying(255) NOT NULL,
  "OpenIDString" character varying(255) NOT NULL,
  CONSTRAINT openidaccounts_pkey PRIMARY KEY ("pId"),
  CONSTRAINT openidaccounts_application_unique UNIQUE ("ApplicationName", "OpenIDString"),
  CONSTRAINT openidaccounts_username_fkey FOREIGN KEY ("UserName", "ApplicationName") REFERENCES "Users" ("Username", "ApplicationName") ON DELETE CASCADE
);
